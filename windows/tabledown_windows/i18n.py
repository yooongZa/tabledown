...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "ko": {
        ...
        "help.message": (
            ...
            "‘표의 수식을 포함해 XML로 복사’ 를 누르거나 Ctrl+Alt+E 를 누르면 모든 셀의 주소·값·빈칸·A1/R1C1 수식과 같은 통합문서의 직접 A1 참조값이 함께 XML로 복사됩니다.\n\n"
    ...
    "en": {
        ...
        "help.message": (
            ...
            "in the tray menu or press Ctrl+Alt+E to copy every cell address, value, blank, A1/R1C1 formula, and direct same-workbook A1 reference value together as XML.\n\n"
