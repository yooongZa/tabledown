...
• Select a formula range in Excel and choose “Copy table with formulas as XML” —
  every value, blank, cell address, A1/R1C1 formula, and direct same-workbook
  A1 reference value is copied together.
...
• Excel 수식 영역을 선택하고 ‘표의 수식을 포함해 XML로 복사’를 누르면
  모든 셀 값·빈칸·주소·A1/R1C1 수식과 같은 통합문서의 직접 A1 참조값이
  함께 복사됩니다.
