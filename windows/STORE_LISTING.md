...
• Select a formula range in Excel and choose “Copy cell values, formulas, and references as XML” —
  every typed raw value, blank, cell address, calculation state, A1/R1C1 formula,
  and direct same-workbook A1 reference value is copied together.
...
• Excel 수식 영역을 선택하고 ‘셀 값·수식·참조를 XML로 복사’를 누르면
  모든 셀의 값 타입·원시값·빈칸·주소·계산 상태·A1/R1C1 수식과
  같은 통합문서의 직접 A1 참조값이 함께 복사됩니다.
...
> “Copy cell values, formulas, and references as XML,” and paste the resulting XML into Notepad.
