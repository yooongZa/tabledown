...
세 수동 복사 메뉴는 Excel desktop app(데스크톱 앱) 전용입니다. **Markdown은 문서의 표 모양을, 두 XML은 AI가 읽을 정보의 구조를 중심으로 정리합니다.** 기존 Excel·Google Sheets ↔ Markdown 자동 복사·붙여넣기는 그대로 사용할 수 있습니다. 아래 메뉴 안내는 2026-09-10 개발 소스 기준이며 배포 버전에는 아직 반영되지 않았습니다.
